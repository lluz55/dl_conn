...
- [x] **Módulo NixOS Declarativo (`nixos/module.nix` ou exportado via `flake.nix`):**
...
- [x] **Integração de Segredos com SOPS-nix:**
...
- [x] **Integração no `hosts/n100/default.nix`:**
...
- [x] **Testes de Integração & Estresse:**
...
- [x] **Documentação & Runbook Operacional:**
...
- `nixos/module.nix`
- `dl-conn.nix`
- `/home/lluz/nixos-config/flake.nix` (input `dl-conn`)
- `/home/lluz/nixos-config/hosts/n100/default.nix` (declaração `services.dl-conn`)
