...
- [x] **Orquestrador de Subprocesso (`internal/tunnel/manager.go`):**
...
- [x] **Parser de URL Efêmera via Expressão Regular:**
...
- [x] **Controle sob Demanda & Inatividade (Opcional configurável):**
