...
- [ ] **Módulo Go e Estrutura de Diretórios:**
...
- [ ] **Ambiente de Desenvolvimento Nix (`flake.nix`):**
...
- [ ] **Esquema de Configuração Declarativa (`internal/config`):**
...
- [ ] **Arquivo de Exemplo (`config.example.yaml`):**
